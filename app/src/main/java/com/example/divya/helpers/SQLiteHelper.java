...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "tipstat";
    ...
    public void onCreate(SQLiteDatabase db) {
           String CREATE_LOGIN_TABLE ="CREATE TABLE member (id TEXT,dob TEXT,status TEXT,ethnicity TEXT,weight TEXT,height TEXT,is_veg TEXT,drink TEXT,imgurl TEXT,created_at TEXT)";
    ...
    public void addmember(Member m)
    {
        ...
        long sql_id = db.insert("member", null, values);
        db.close();
    ...
    public ArrayList<Member> getDetails() {
        ...
        if (cursor.moveToFirst()) {
            do {
            	member.add(new Member(cursor.getString(cursor.getColumnIndex("id")),cursor.getString(cursor.getColumnIndex("dob")),
    ...
    public void deleteItem(String item)
    {
        ...
        try
        {
            db.delete("member", "no = ?", new String[] { item });
        }
        catch(Exception e)
        {
            e.printStackTrace();
